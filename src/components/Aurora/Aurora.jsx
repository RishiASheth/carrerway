...
export default function Aurora({ 
  ...
  const propsRef = useRef({ colorStops, amplitude, speed, time });
  propsRef.current = { colorStops, amplitude, speed, time };
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      const { time: propTime = t * 0.01, speed = 1.0 } = propsRef.current;
